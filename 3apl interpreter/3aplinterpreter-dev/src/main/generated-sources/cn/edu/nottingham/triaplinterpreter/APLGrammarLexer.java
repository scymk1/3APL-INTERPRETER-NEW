...
public class APLGrammarLexer extends Lexer {
	...
	public static final int
		...
		IDENT=33, CAPVAR=34, NAMEVAR=35, ALPHA=36, DIGIT=37, WS=38;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PROGRAM", "LOAD", "CBASE", "BBASE", "GBASE", "PBASE", "PGRULE", "PRRULE", 
			"QUOTE", "SEMI", "LBRACE", "RBRACE", "DOT", "BARROW", "COMMA", "AND", 
			"OR", "LPAREN", "RPAREN", "SEND", "JAVA", "QUESTION", "IF", "THEN", "ELSE", 
			"WHILE", "DO", "SEMICOLON", "PARROW", "ORS", "NOT", "TRUE", "IDENT", 
			"CAPVAR", "NAMEVAR", "ALPHANUMERIC", "ALPHA", "DIGIT", "WS"
		};
	}
